  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://enormous-mint-tomcat.ngrok-free.app/v1/auth/login",
        {
          method: "POST",
          headers: {
    ...
    <div className="h-screen w-full bg-blue-700 flex justify-center items-center">
      <div className="w-full tablet:w-1/2 p-10 tablet:px-36 bg-blue-700 flex flex-col gap-8 text-white">
        <div>
          <div className="flex gap-7 justify-center tablet:hidden">
            ...
            <img
              ...
              src="/img/upw.png"
            ></img>
            <img className="w-20" src="/img/Logo-UII-White.png"></img>
          </div>
        </div>
        ...
        <div className="text-white text-3xl tablet:text-4xl font-bold tablet:flex tablet:justify-between text-center tablet:text-start">
          ...
          <img
            className="w-20 h-auto object-contain hidden tablet:flex"
            src="/img/upw.png"
          ></img>
        </div>
        ...
        <div className="w-full flex flex-col gap-6">
          <input
            ...
            className="p-2.5 bg-transparent text-white text-sm focus:outline-none"
            value={email}
      ...
      <div className="hidden tablet:flex tablet:flex-col   bg-white w-1/2 h-screen justify-center items-center gap-10">
        <div className="flex gap-14">
          <img
            ...
            src="/img/keepup.png"
          ></img>
          <img className="w-14 h-auto object-contain" src="/img/upb.png"></img>
          <img className="w-24" src="/img/UII_LOGO.png"></img>
        </div>

        <img
          className="object-contain max-w-[80%] max-h-[80%] mx-auto"
          src="/img/Mind map-pana (1) 1.png"
          alt="Mind map image"
        />
      </div>
    </div>
